...
def kryptos_decrypt(ciphertext, key):
    ...
    # Remove padding
    return kryptos_unpad(padded_data)
...
if __name__ == "__main__":
    ...
    # Encrypt the data
    encrypted_data = kryptos_encrypt(data, key)
    print("Encrypted:", encrypted_data)
    
    # Decrypt the data
    decrypted_data = kryptos_decrypt(encrypted_data, key)
