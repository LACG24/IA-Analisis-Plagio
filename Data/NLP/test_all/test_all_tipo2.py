...
class TestNLPFunctions(unittest.TestCase):
    ...
    def test_lda_topic_modeling_custom(self):
    ...
    def test_train_text_classifier_custom(self):
    ...
    def test_cosine_similarity_texts_custom(self):
    ...
    def test_generate_text_custom(self):
