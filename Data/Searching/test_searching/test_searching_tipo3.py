...
class TestSearchAlgorithms(unittest.TestCase):
    ...
    def setUp(self):
        self.array = [2, 3, 4, 10, 40]
        self.target_present = 10
        self.target_absent = 5

    def test_linear_search_present(self):
        result = linear_search(self.array, self.target_present)
        self.assertEqual(result, 3)

    def test_iterative_binary_search_present(self):
        result = binary_search_iterative(self.array, 0, len(self.array)-1, self.target_present)
        self.assertEqual(result, 3)

    def test_exponential_search_present(self):
        result = exponential_search(self.array, self.target_present)
        self.assertEqual(result, 3)

    def test_fibonacci_search_present(self):
        result = fibonacci_search(self.array, self.target_present)
        self.assertEqual(result, 3)

    def test_jump_search_present(self):
        result = jump_search(self.array, self.target_present)
        self.assertEqual(result, 3)

    def test_interpolation_search_present(self):
        result = interpolation_search(self.array, self.target_present)
        self.assertEqual(result, 3)

    def test_ternary_search_present(self):
        result = ternary_search(self.array, self.target_present)
        self.assertEqual(result, 3)

    def test_linear_search_absent(self):
        result = linear_search(self.array, self.target_absent)
        self.assertEqual(result, -1)

    def test_iterative_binary_search_absent(self):
        result = binary_search_iterative(self.array, 0, len(self.array)-1, self.target_absent)
        self.assertEqual(result, -1)

    def test_exponential_search_absent(self):
        result = exponential_search(self.array, self.target_absent)
        self.assertEqual(result, -1)

    def test_fibonacci_search_absent(self):
        result = fibonacci_search(self.array, self.target_absent)
        self.assertEqual(result, -1)

    def test_jump_search_absent(self):
        result = jump_search(self.array, self.target_absent)
        self.assertEqual(result, -1)

    def test_interpolation_search_absent(self):
        result = interpolation_search(self.array, self.target_absent)
        self.assertEqual(result, -1)

    def test_ternary_search_absent(self):
        result = ternary_search(self.array, self.target_absent)
        self.assertEqual(result, -1)
