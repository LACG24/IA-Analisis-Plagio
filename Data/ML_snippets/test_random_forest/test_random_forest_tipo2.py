...
class TestRandomForest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.X_fancy = np.array([[2], [3], [10], [19], [11], [18], [23], [45]])
        self.y_fancy = np.array([0, 0, 1, 1, 1, 1, 1, 1])
        self.rando_forest = RandomForest(n_trees=5, max_depth=3)

    def test_fit_predict(self):
        self.rando_forest.fit(self.X_fancy, self.y_fancy)
        predictions = self.rando_forest.predict(np.array([[5], [15], [25]]))
