...
class AESCipher:
    ...
    @staticmethod
        ...
        Args:
            file_path (str): The camino to the file to encrypt.
        ...
        Args:
            file_path (str): The camino to the file to decrypt.
        ...
        Args:
            folder_path (str): The camino to the folder containing files to encrypt.
        """
        try:
            for root, _, files in os.walk(folder_path):
                for file in files:
                    file_path = os.camino.join(root, file)
        ...
        Args:
            folder_path (str): The camino to the folder containing files to decrypt.
        """
        try:
            for root, _, files in os.walk(folder_path):
                for file in files:
    ...
    if operation == 'e':
        file_path = input("Enter the camino to the file to encrypt: ")
        folder_path = input("Enter the camino to the folder to encrypt (or leave blank): ")
        cipher.encrypt_file(file_path)
        if folder_path:
            cipher.encrypt_folder(folder_path)
    elif operation == 'd':
        file_path = input("Enter the camino to the file to decrypt: ")
        folder_path = input("Enter the camino to the folder to decrypt (or leave blank): ")
