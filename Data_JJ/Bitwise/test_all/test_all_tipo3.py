...
class TestAdvancedBitManipulation(unittest.TestCase):
    ...
    def test_clear_lsb_up_to_pos_alternative(self):
    ...
    def test_isolate_rightmost_one_alternative(self):
