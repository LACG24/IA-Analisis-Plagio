...
class TestPasswordGenerator(unittest.TestCase):
    def setUp(self):
        self.pw_gen = PasswordGenerator(length=12, use_upper=True, use_lower=True, use_digits=True, use_symbols=True)

    def test_generate_password_length(self):
        password, _ = self.pw_gen.generate_password()
    ...
    def test_password_hashing(self):
        password, hashed = self.pw_gen.generate_password()
